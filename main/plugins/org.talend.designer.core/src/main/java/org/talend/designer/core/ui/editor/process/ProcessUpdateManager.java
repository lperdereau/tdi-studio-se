...
public class ProcessUpdateManager extends AbstractUpdateManager {
                ...
                if (!param.isBuiltIn()) {
                    ...
                    ContextItem contextItem = findContextItem(allContextItem, source);
                        ...
                        if (paramLink != null && contextType != null) {// Compare use UUID
                            ContextParameterType contextParameterType = findContextParameterType(contextType, paramLink);
    ...
    private ContextParameterType findContextParameterType(ContextType contextType, ContextParamLink paramLink) {
        for (Object obj : contextType.getContextParameter()) {
            if (obj instanceof ContextParameterType) {
                ContextParameterType parameterType = (ContextParameterType) obj;
                if (StringUtils.equals(ResourceHelper.getUUID(parameterType), paramLink.getId())) {
